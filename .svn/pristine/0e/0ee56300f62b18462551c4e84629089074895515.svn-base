...
public class TraxContractActivityViewRowImpl extends ViewRowImpl {
    ...
    public static final int EXPECTEDSTARTDATE =
        AttributesEnum.ExpectedStartDate.index();
    public static final int ACTUALSTARTDATE =
        AttributesEnum.ActualStartDate.index();
    ...
    public static final int TRAXCONTRACTVIEW =
        AttributesEnum.TraxContractView.index();
    public static final int ACTIVITYTYPELOOKUP =
        AttributesEnum.ActivityTypeLookup.index();
    public static final int ACTIVITYSTATUSLOOKUP =
        AttributesEnum.ActivityStatusLookup.index();
    public static final int ACTIVITYPRIORITYLOOKUP =
        AttributesEnum.ActivityPriorityLookup.index();
    public static final int ACTIVITYSUBTYPELOOKUP =
        AttributesEnum.ActivitySubTypeLookup.index();
    ...
    public TraxActivityContractImpl getTraxActivityContract() {
        return (TraxActivityContractImpl)getEntity(1);
    }
    ...
    /**
     * Gets the associated <code>Row</code> using master-detail link TraxContractView.
     */
    public Row getTraxContractView() {
        return (Row)getAttributeInternal(TRAXCONTRACTVIEW);
    }

    /**
     * Sets the master-detail link TraxContractView between this object and <code>value</code>.
     */
    public void setTraxContractView(Row value) {
        setAttributeInternal(TRAXCONTRACTVIEW, value);
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        TraxActivityContractImpl newActivityContract =
            this.getTraxActivityContract();
        ...
        try {
            ...
            newActivityContentOwner.setContentOwnerId((Number)this.getTraxContractView().getAttribute("ContentOwnerId"));
            ...
            newActivityUser.revert();
            newActivityContentOwner.revert();
            throw new RowCreateException(true, /* EO Row? */"ContractActivity",
