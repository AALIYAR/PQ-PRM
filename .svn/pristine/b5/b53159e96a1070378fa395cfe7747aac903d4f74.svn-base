...
public class PrmBaseEntity extends EntityImpl {
    ...
    public String getLoginUserId() {
        try {
            ...
            System.out.println("Error while getting user id in PrmBaseEntity :" +
                               ee.toString());
        }
...
conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_READ_ONLY);
 ...
 ((oracle.jbo.domain.Number)this.getAttribute("Id")).intValue();
            ...
            System.out.println("*******************Exception while inseting(primary key generation) in PrmBaseEntity.***********************");
