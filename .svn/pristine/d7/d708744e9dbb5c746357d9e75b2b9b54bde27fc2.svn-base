...
public class NTCRightsViewRowImpl extends ViewRowImpl {
    ...
    /**
     * Gets the attribute value for LAST_UPDATED_DATE using the alias name LastUpdatedDate2.
     * @return the LAST_UPDATED_DATE
     */
    ...
    /**
     * Sets <code>value</code> as attribute value for LAST_UPDATED_DATE using the alias name LastUpdatedDate2.
     * @param value value to set the LAST_UPDATED_DATE
     */
