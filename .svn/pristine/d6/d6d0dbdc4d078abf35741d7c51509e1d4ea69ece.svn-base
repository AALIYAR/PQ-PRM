...
// ---    Thu Dec 19 10:29:12 EST 2013
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TraxContactMethodImpl extends PrmBaseEntity {
    ...
    public static final int CONTACTMETHOD = AttributesEnum.ContactMethod.index();
    public static final int CONTACTDETAIL1 = AttributesEnum.ContactDetail1.index();
    public static final int CONTACTDETAIL2 = AttributesEnum.ContactDetail2.index();
    public static final int CONTACTMETHODNOTE = AttributesEnum.ContactMethodNote.index();
    ...
    public static final int CONTACTMETHODSUBTYPE = AttributesEnum.ContactMethodSubType.index();
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = EntityDefImpl.findDefObject("com.pq.tracs.model.eo.TraxContactMethod");
        }
    ...
    /**
     * Validation method for TraxContactMethod.
     */
    ...
    protected void prepareForDML(int operation, TransactionEvent e) {
        ...
        try {
            if (operation == DML_INSERT || operation == DML_UPDATE) {
                if (getTraxContact().getTraxContactMethod().getRowCount() <= 1) {
                    setPrimaryFlag("Y");
                }
            }
        } catch (Exception efg) {
