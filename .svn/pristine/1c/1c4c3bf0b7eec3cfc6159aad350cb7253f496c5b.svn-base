...
// ---    Tue Oct 30 11:53:43 EDT 2012
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class TraxImportFileImpl extends PrmBaseEntity {
    ...
    public enum AttributesEnum {
        ...
        ,
        TraxImportParseError {
            public Object get(TraxImportFileImpl obj) {
                return obj.getTraxImportParseError();
            }
    ...
    public static final int TRAXIMPORTPARSEERROR = AttributesEnum.TraxImportParseError.index();
     ...
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getTraxImportParseError() {
        return (RowIterator)getAttributeInternal(TRAXIMPORTPARSEERROR);
    }
